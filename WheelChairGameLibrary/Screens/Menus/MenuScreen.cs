    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 0; i < menuEntries.Count; i++)
            {
                ...
                menuEntry.Draw(this, position, isSelected, gameTime, 0.7f);
            ...
            Vector2 titleOrigin = ScreenManager.Font.MeasureString(menuTitle) / 2;
            Color titleColor = new Color(192, 192, 192, TransitionAlpha);
            float titleScale = 1.25f;

            titlePosition.Y -= transitionOffset * 100;

            ScreenManager.SpriteBatch.DrawString(ScreenManager.Font, menuTitle, titlePosition, titleColor, 0,
