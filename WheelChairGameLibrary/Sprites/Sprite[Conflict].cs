...
namespace MortalKomatG
{
    public class Sprite
    {
        ...
        {
            return new Rectangle((int)position.X + BB_OFFSET_X, (int)position.Y, BB_WIDTH, BB_HEIGHT);
        }
        ...
        public Rectangle getBoundingBox2()
        {
            ...
            return new Rectangle(
                    ...
                    (int)position.Y + activeSpriteAnimation.getAnimationData().offsetY,
                    activeSpriteAnimation.getAnimationData().sourceRectangle.Width, activeSpriteAnimation.getAnimationData().sourceRectangle.Height);
        }
        ...
        public virtual void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            spriteBatch.Draw(texture, 
                new Rectangle(
                    (int)position.X + offsetX,
                    (int)position.Y + spriteAnimationData.offsetY, spriteAnimationData.sourceRectangle.Width, spriteAnimationData.sourceRectangle.Height),
